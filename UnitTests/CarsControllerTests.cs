...
namespace dissertation_test_repo.Tests.Controllers
{
    public class CarsControllerTests
    {
        ...
        [Test]
        public async Task GetAvailableCars_ReturnsStatusCode500_WhenExceptionOccurs()
        {
            // Arrange
        ...
        [Test]
        public async Task MarkAsUnavailable_ReturnsStatusCode500_WhenExceptionOccurs()
        {
            // Arrange
            int carId = 1;
        ...
        [Test]
        public async Task GetAveragePrice_ReturnsOkResult_WhenPriceIsCalculated()
        {
            // Arrange
            double averagePrice = 10000.00;
        ...
        [Test]
        public async Task GetAveragePrice_ReturnsStatusCode500_WhenExceptionOccurs()
        {
            // Arrange
