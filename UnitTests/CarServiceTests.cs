...
namespace dissertation_test_repo.Tests.Services
{
    ...
    public class CarServiceTests
    {
        ...
        public async Task MarkAsUnavailableAsync_ReturnsCarResponseDto_WhenCarIsFound()
        {
            // Arrange
            int carId = 1;
            var car = new Car { Id = carId, IsAvailable = true, Make = "Toyota", Model = "Corolla", Year = 2020, Color = "Red", Price = 20000 };
            ...
            _carRepository.Received(1).UpdateAsync(carId, Arg.Is<Car>(c => !c.IsAvailable));
        }
