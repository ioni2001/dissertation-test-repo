...
namespace dissertation_test_repo.Tests.Services
{
    ...
    public class CarServiceTests
    {
        ...
        {
            // Arrange
            var cars = new List<Car> { new Car { Id = 1, IsAvailable = true }, new Car { Id = 2, IsAvailable = true } };
            ...
            result.Should().BeAssignableTo<IEnumerable<CarResponseDto>>();
        ...
        public async Task MarkAsUnavailableAsync_ReturnsCarResponseDto_WhenCarIsFound()
        {
            ...
            _logger.Received(1).LogInformation("Marked car as unavailable with ID: {CarId}", carId);
        }
