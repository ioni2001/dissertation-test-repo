...
namespace dissertation_test_repo.Tests.Controllers
{
    public class CarsControllerTests
    {
        ...
        public async Task GetAvailableCars_ReturnsOkResult_WhenCarsExist()
        {
            ...
            // Act
            var result = await _controller.GetAvailableCars() as ActionResult<IEnumerable<CarResponseDto>>;
        ...
        [Test]
        public async Task GetAvailableCars_ReturnsInternalServerError_WhenExceptionIsThrown()
        {
            // Arrange
        ...
        [Test]
        public async Task MarkAsUnavailable_ReturnsOkResult_WhenCarIsFoundAndUpdated()
        {
            // Arrange
            int carId = 1;
            ...
            // Act
            var result = await _controller.MarkAsUnavailable(carId) as ActionResult<CarResponseDto>;
        ...
        [Test]
        public async Task MarkAsUnavailable_ReturnsNotFound_WhenCarIsNotFound()
        {
            // Arrange
            int carId = 1;
        ...
        [Test]
        public async Task MarkAsUnavailable_ReturnsInternalServerError_WhenExceptionIsThrown()
        {
            // Arrange
            int carId = 1;
        ...
        {
            // Arrange
            double averagePrice = 15000.50;
            _carService.GetAveragePriceAsync().Returns(averagePrice);

            // Act
            var result = await _controller.GetAveragePrice() as ActionResult<double>;
        ...
        [Test]
        public async Task GetAveragePrice_ReturnsInternalServerError_WhenExceptionIsThrown()
        {
            // Arrange
