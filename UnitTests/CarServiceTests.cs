...
namespace dissertation_test_repo.Tests.Services
{
    ...
    public class CarServiceTests
    {
        ...
        public async Task GetAvailableCarsAsync_ReturnsListOfCarResponseDto_WhenCarsAreAvailable()
        {
            ...
            // Assert
            result.Should().BeEquivalentTo(cars.Select(c => new CarResponseDto
            {
                Id = c.Id,
                Make = c.Make,
                Model = c.Model,
        ...
        public async Task MarkAsUnavailableAsync_ReturnsCarResponseDto_WhenCarIsFoundAndUpdated()
        {
            ...
            // Assert
            result.Should().BeEquivalentTo(new CarResponseDto
            {
                Id = car.Id,
                Make = car.Make,
                Model = car.Model,
        ...
        [Test]
        public async Task DeleteCarAsync_ThrowsException_WhenCarIsNotAvailable()
        {
            // Arrange
            int carId = 1;
